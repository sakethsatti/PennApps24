        ...
        messages: [
          {
            role: "system",
            content:
              "Summarize the following transcription into clear, concise notes. Include a title for this. ",
          },
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center p-4 bg-white min-h-screen font-[Outfit]">
      ...
      <p className="text-lg mb-4 text-black text-center">
        Record or Submit a Recording of a Lesson.
      </p>
      ...
      <div className="mt-8">
        <button
          className={`px-6 py-3 w-full max-w-xs bg-black text-white rounded-md font-semibold hover:bg-gray-800 transition-colors duration-300 ${
      ...
      {notes && (
        <div className="mt-8">
          ...
          <pre className="whitespace-pre-wrap bg-gray-100 p-4 mt-4 rounded-md text-black">
            {notes}
          </pre>
          <button
